                ...
                {menuNav.map((navItem) => (
                    <List
                        ...
                        {...(navItem.link ? {
                            ...
                            subheader: (
                                <ListSubheader
                                    sx={{ backgroundColor: bgColor, color: navColor }}
                                    component="div"
                    ...
                    >
                        ...
                        {navItem.children.map((item) => (
                            <div key={item.key}>
                                <NavLink className='nav-link' to={item.children ? null : item.link}>
                                    <ListItemButton
                                        onClick={() => {
                                    ...
                                    >
                                        ...
                                        {item.children ? openMenu === item.key ? <ExpandLess /> : <ExpandMore sx={{ display: !open ? 'none' : 'block', }} /> : ''}
